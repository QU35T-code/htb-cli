...
utils_group.add_argument("-ip", help="Get Target IP Address", action='store_true')
utils_group.add_argument("-cli", help="Get Local IP Address", action='store_true')
...
htb_group.add_argument("-start", help="Start a machine", action='store_true')
htb_group.add_argument("-stop", help="Stop current machine", action='store_true')
htb_group.add_argument("-reset", help="Reset a machine", action='store_true')
...
if args.ip:
    ...
    os.system(f"{dirname}/start.py")
elif args.reset:
    os.system(f"{dirname}/reset.py")